...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.employeeManagement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.employee-managements.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="employee_name">{{ trans('cruds.employeeManagement.fields.employee_name') }}</label>
                <input class="form-control {{ $errors->has('employee_name') ? 'is-invalid' : '' }}" type="text" name="employee_name" id="employee_name" value="{{ old('employee_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employee_email') ? 'is-invalid' : '' }}" type="text" name="employee_email" id="employee_email" value="{{ old('employee_email') }}" required>
